...
public class GenericMethodSelector : OdinSelector<MethodInfo>
{
    ...
    private List<Type> methodArgs;
    
    
    public GenericMethodSelector(UnityEngine.Object obj)
    {
        this.target = obj;
    ...
    public GenericMethodSelector(UnityEngine.Object obj, Type returnType)
    {
    ...
    public GenericMethodSelector(UnityEngine.Object obj, Type returnType, List<Type> matchingArgs )
    {
        this.ReturnType = returnType;
        this.target = obj;
        this.gameObjectTarget = this.target as GameObject;
        this.methodArgs = matchingArgs;
        var component = this.target as Component;
        if (component)
        {
            this.gameObjectTarget = component.gameObject;
    ...
    public bool IsValidSelection(IEnumerable<DelegateInfo> collection)
    {
    ...
    private void AddMethods(OdinMenuTree tree, Type type, UnityEngine.Object target, BindingFlags flags)
    {
        ...
        foreach (var mi in methods)
        {
            ...
            {
                var menuItem = tree.AddObjectAtPath(path, mi).Last();
