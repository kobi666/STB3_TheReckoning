...
{
    [CustomEditor(typeof(CustomBGCBoxCollider))]
    public class CustomBGCBoxColliderEditor : BGCcColliderAbstractEditor
    {
        private static readonly List<BoxCollider2D> TempColliders = new List<BoxCollider2D>();

        private CustomBGCBoxCollider Collider2DBox
        {
            get { return (CustomBGCBoxCollider) cc; }
        }
        ...
        private void MiscParams()
        {
            ...
            EditorGUILayout.PropertyField(serializedObject.FindProperty("ParentMyGameObject"));
            EditorGUILayout.PropertyField(serializedObject.FindProperty("CollisionAggregator"));
        ...
        public static void DrawGizmos(CustomBGCBoxCollider collider2DBox, GizmoType gizmoType)
        {
